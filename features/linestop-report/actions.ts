...
async function requireReportAccess() { await requireRoles("ADMIN", "CCR_OPERATION", "CCR_GROUP_LEADER"); }
async function requireManager() { await requireRoles("ADMIN", "CCR_GROUP_LEADER"); }
